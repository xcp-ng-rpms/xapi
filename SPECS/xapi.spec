...
#   - git format-patch --no-numbered --no-signature v25.21.0..v25.21.0-8.3
...
# Backports:
# Backports of several RRD fixes from upstream, all are in v25.22.0
Patch1006: 0006-xcp-rrdd-change-the-code-responsible-for-filtering-o.patch
Patch1007: 0007-rrdd-Avoid-missing-aggregation-of-metrics-from-newly.patch

# Backport from upstream v25.22.0 (https://github.com/xapi-project/xen-api/pull/6507)
Patch1008: 0008-CA-410085-Improving-clearing-cgroup-after-vfork.patch
...
Patch1009: 0009-xapi-stdext-threads-calibrate-ratio-for-delay-times.patch

# AMD pci MMIO Writeback workaround, upstream in v25.26.0
Patch1010: 0010-xenopsd-set-xen-platform-pci-bar-uc-key-in-xenstore.patch
...
%changelog
* Tue Jul 15 2025 Andrii Sultanov <andriy.sultanov@vates.tech> - 25.21.0-2.1
- Update to upstream 25.21.0-2
...
- Rename 0025-xcp-rrdd-change-the-code-responsible-for-filtering-o.patch to
  0006-xcp-rrdd-change-the-code-responsible-for-filtering-o.patch
- Rename 0026-rrdd-Avoid-missing-aggregation-of-metrics-from-newly.patch to
  0007-rrdd-Avoid-missing-aggregation-of-metrics-from-newly.patch
- Rename 0028-xenopsd-set-xen-platform-pci-bar-uc-key-in-xenstore.patch to
  0010-xenopsd-set-xen-platform-pci-bar-uc-key-in-xenstore.patch
- Add 0008-CA-410085-Improving-clearing-cgroup-after-vfork.patch
- Add 0009-xapi-stdext-threads-calibrate-ratio-for-delay-times.patch
